...
function Header()
{
   $this->Image("bibliotecaheader.jpg",0,0, 210, 55);
    ...
    $this->Cell(50);
    // Título
    $this->Cell(100,105,'Reporte de Solicitudes Pendientes',10,0,'C');
    // Salto de línea
    $this->Ln(60);
...
$consulta = "SELECT u.name,u.cedula,solicitud.estatus_solicitud, solicitud.id_estudiante,l.nombre_libro FROM solicitud INNER JOIN users u ON solicitud.id_estudiante=u.id INNER JOIN libros l ON solicitud.id_libro=l.id_libro WHERE estatus_solicitud='Pendiente'";
